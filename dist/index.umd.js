(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('cornerstone-core'), require('cornerstone-wado-image-loader'), require('dicom-parser'), require('react'), require('cornerstone-tools'), require('react-dom'), require('lodash.debounce')) :
  typeof define === 'function' && define.amd ? define(['exports', 'cornerstone-core', 'cornerstone-wado-image-loader', 'dicom-parser', 'react', 'cornerstone-tools', 'react-dom', 'lodash.debounce'], factory) :
  (global = global || self, factory(global['react-cornerstone-viewport'] = {}, global.cornerstone, global.cornerstoneWADOImageLoader, global.dicomParser, global.React, global.cornerstoneTools, global.ReactDOM, global.debounce$1));
