...
function (_PureComponent) {
  ...
  createClass(ViewportOverlay, [{
    ...
    value: function render() {
      ...
      var normal = React.createElement(React.Fragment, null, React.createElement("div", {
        className: "top-left overlay-element"
      }, React.createElement("div", null, formatPN$1(patientName)), React.createElement("div", null, patientId)), React.createElement("div", {
        className: "top-right overlay-element"
      }, React.createElement("div", null, studyDescription), React.createElement("div", null, formatDA$1(studyDate), " ", formatTM$1(studyTime))), React.createElement("div", {
        className: "bottom-right overlay-element"
      }, React.createElement("div", null, "Zoom: ", zoomPercentage, "%"), React.createElement("div", null, wwwc), React.createElement("div", {
        className: "compressionIndicator"
      }, compression)), React.createElement("div", {
        className: "bottom-left overlay-element"
      }, React.createElement("div", null, seriesNumber >= 0 ? "Ser: ".concat(seriesNumber) : ''), React.createElement("div", null, stackSize > 1 ? "Img: ".concat(instanceNumber, " ").concat(imageIndex, "/").concat(stackSize) : ''), React.createElement("div", null, frameRate >= 0 ? "".concat(formatNumberPrecision$1(frameRate, 2), " FPS") : '', React.createElement("div", null, imageDimensions), React.createElement("div", null, isValidNumber$1(sliceLocation) ? "Loc: ".concat(formatNumberPrecision$1(sliceLocation, 2), " mm ") : '', sliceThickness ? "Thick: ".concat(formatNumberPrecision$1(sliceThickness, 2), " mm") : ''), React.createElement("div", null, seriesDescription))));
      return React.createElement("div", {
...
function (_PureComponent) {
  ...
  createClass(LoadingIndicator, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, this.props.error ? React.createElement("div", {
        className: "imageViewerErrorLoadingIndicator loadingIndicator"
      }, React.createElement("div", {
        className: "indicatorContents"
      }, React.createElement("h4", null, "Error Loading Image"), React.createElement("p", {
        className: "description"
      }, "An error has occurred."), React.createElement("p", {
        className: "details"
      }, this.props.error.message))) : React.createElement("div", {
        className: "imageViewerLoadingIndicator loadingIndicator"
      }, React.createElement("div", {
        className: "indicatorContents"
      }, React.createElement("h2", null, pc < 100 ? 'Loading...' : 'Loaded -', React.createElement("i", {
        className: "fa fa-spin fa-circle-o-notch fa-fw"
      }), ' ', percComplete), pc === 100 && React.createElement("p", null, "Processing..."))));
    }
  }]);
...
function (_PureComponent) {
  ...
  createClass(ViewportOrientationMarkers, [{
    ...
    value: function render() {
      ...
      }, markers.top), React.createElement("div", {
...
function (_Component) {
  ...
  function CornerstoneViewport(props) {
    ...
    defineProperty(assertThisInitialized(_this), "onImageLoaded", function () {
      ...
      _this.props.onImageLoaded(_this.numImagesLoaded);
    });
  ...
  createClass(CornerstoneViewport, [{
    ...
    value: function getOverlay() {
      ...
      return imageId && windowWidth && isOverlayVisible && React.createElement(Component, {
    ...
    value: function getOrientationMarkersOverlay() {
      ...
      return React.createElement(ViewportOrientationMarkers, {
    ...
    value: function render() {
      ...
      }, displayLoadingIndicator && this.getLoadingIndicator(), React.createElement("canvas", {
        className: "cornerstone-canvas"
      }), this.getOverlay(), this.getOrientationMarkersOverlay()), React.createElement(ImageScrollbar, {
